...
export class ChangeActiveToStatus1647357458256 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO "temporary_neural_model"("id", "file_path", "epochs", "hiddenLayerCount", "lstm_count", "status", "cityId") SELECT "id", "file_path", "epochs", "hiddenLayerCount", "lstm_count", "ready", "cityId" FROM "neural_model"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`INSERT INTO "neural_model"("id", "file_path", "epochs", "hiddenLayerCount", "lstm_count", "ready", "cityId") SELECT "id", "file_path", "epochs", "hiddenLayerCount", "lstm_count", "status", "cityId" FROM "temporary_neural_model"`);
        await queryRunner.query(`DROP TABLE "temporary_neural_model"`);
    }
